...
function DoItShowIt(table_id, item) {
    ...
    var msg = "<td class='norm_text'>" + value + "</td>";
...
$(document).ready(function () {
    ...
    DoItShowIt("#res_table1", "moment().format('MMM DD YYYY')");
    ...
    // DoItShowIt("#res_table1", "moment('19851211', 'YYYYMMDD').fromNow()");
    // DoItShowIt("#res_table1", "moment('20120620', 'YYYYMMDD').fromNow()");
    // DoItShowIt("#res_table1", "moment().startOf('day').fromNow()");
    // DoItShowIt("#res_table1", "moment().endOf('day').fromNow()");
    // DoItShowIt("#res_table1", "moment().startOf('hour').fromNow()");
