App =
    ...
    load_movies: (movies, show_countdown) ->
        ...
        for movie in movies
            ...
            movie_item = $('<div/>').addClass('col-xl-3 col-sm-6 col-xs-12')
            ...
            poster_footer.append $('<div/>').addClass('col-9').append $('<a/>').addClass('button btn btn-primary w-100').text 'Ver Trailer'
